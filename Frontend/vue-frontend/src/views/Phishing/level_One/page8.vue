<template>
    <div class="w-full h-full rounded-2xl bg-[#F6F6F6] flex flex-col text-white overflow-auto pb-10">
        <div class="w-full p-3 bg-primary flex justify-between items-center px-8 rounded-tr-xl rounded-tl-xl">
            ...
            <BaseButton :click="ComponentStore.previousPage" :theme="'white'">Previous</BaseButton>

            <div class="flex gap-5 items-center">
                &lt; Leave Scenario
                <button v-if="!quizCompleted" class="rounded-md bg-primary text-white psm px-5">Submit</button>

                <BaseButton v-else :click="ComponentStore.nextPage" :theme="'white'">
                    NEXT
                </BaseButton>
            </div>
                ...
                <div
                    ...
                    <div v-if="!quizCompleted">
                        ...
                        <div class="flex justify-between w-full">
                            ...
                            <BaseButton
                                :click="nextQuestion"
                                :with-hover="selectedOption.length === 0 ? false : true"
                                >
                                Next Question
                            </BaseButton>
...
import { QuizQuestion } from '@/composables/Phishing/levelOne/pageEight/index'
...
const prevQuestion = () => {
    if (selectedOption.value.length <= 0) ComponentStore.previousPage();
